...
public class TC001_Valid_Search extends localTestBase {
  ...
  public void validSearch() throws InterruptedException {
	  ...
	  test = report.startTest("TC#001 Valid Search"); // extent reports is a maven dependency to generate reports
	  ...
	  test.log(LogStatus.PASS, "click on search and input  a query");
	  /*
	  ...
	  Assert.assertTrue(playerResult.contains("Copa Argentina"));  //this should be change to Messi for correct behavior
